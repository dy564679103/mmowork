...
namespace Network
{
    ...
    {
        public ServerIpType serverIpType = ServerIpType.LocalNetworkServer;

        public enum ServerIpType
        {
            LocalNetworkServer = 0,
            BaiduNetworkServer = 1,
        };
        ...
        public const string BAIDU_NETWORK_SERVER_ADDRESS = "182.61.19.84";                  //百度云服务器链接IP地址
        public const string LOCAL_SERVER_ADDRESS = "127.0.0.1";                             //百度云服务器链接IP地址
        public const string USER_NAME = "USER_NAME";                                        //缓存账号
        public const string PASS_WORD = "PASS_WORD";                                        //缓存密码
        public const string IS_REMEMBER_ACCOUNT = "IS_REMEMBER_ACCOUNT";                    //记住账号
        public const string IS_Agree_The_UserAgreement = "IS_Agree_The_UserAgreement";      //同意《用户协议》
